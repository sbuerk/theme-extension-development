...
A **development aid** for the two instances `instance-core-13/` and
`instance-core-14/`. It is never released, never installed anywhere else, and
...
installs TYPO3 and imports the set when either is missing;
