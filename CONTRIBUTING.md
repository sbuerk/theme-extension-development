...
[sbuerk/theme-extension-development](https://github.com/sbuerk/theme-extension-development).
...
Build/Scripts/runTests.sh -s checkIconsBuild # committed icons equal the pinned package
