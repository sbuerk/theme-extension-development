...
The site header comes in four arrangements, selected by the **site setting**
:typoscript:`theme.header.variant`:
...
The ``actions`` variant takes two more settings:
...
through the classic static template rather than the site set. Where both
exist, TYPO3 lets the site setting win. See :ref:`configuration-site-settings`.
