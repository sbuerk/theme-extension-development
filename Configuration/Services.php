...
return static function (
    ...
    // core version, `Core12/` on TYPO3 v12 and `Core13/` on TYPO3 v13. Both
    // directories are autoloaded by composer, but only the one matching the
    // running core version is registered as services, so an implementation
    // may safely use API that exists in its core version only.
