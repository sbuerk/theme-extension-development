...
return [
    ...
    'columns' => [
        ...
        // nullable column from "dbType" on v12.4.45 and v13.4.35 alike - which
        // is why "ext_tables.sql" does not declare it - and DataHandler stores
        // an empty value as NULL rather than as a date.
        'date' => [
        ...
        // declaration is the nullable TEXT v13.4 derives for a select with an
        // "itemsProcFunc".
        'link_icon' => [
        ...
        // Declared in "ext_tables.sql" like "link_icon": v12.4 derives no
        // column from a "select" without an MM table, and the declaration is
        // the nullable TEXT v13.4 derives for a select with an "itemsProcFunc".
        'icon' => [
