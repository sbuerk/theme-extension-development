 ...
 * the failure `LegacyDeliveryTest` exists for. The paths are the theme
 * delivery of the running core (`ThemeSiteTrait`: the site set on v13, the
 * static include on v12) and `include_static_file` as such.
 *
