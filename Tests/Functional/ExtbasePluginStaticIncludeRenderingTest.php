 ...
 *
 * On v12 `ExtbasePluginRenderingTest` takes the same path, as `ThemeSiteTrait`
 * arranges the static include there; on v13 it takes the set, and this test
 * is what covers the static include path. It runs on both, so the path is
 * held to the same assertions on either core version.
 *
