...
namespace SBUERK\ThemeExtensionDevelopment\Tests\Functional\Core12\Example;
 ...
 *
 * Core version aware tests live below `Tests/Functional/Core12/`, mirroring the
...
final class ExampleTest extends AbstractFunctionalTestCase
{
    ...
    {
        $this->assertSame(
            'Example implementation for TYPO3 v12',
    ...
    public function implementationOfTheOtherCoreVersionIsNotRegistered(): void
    {
        $this->assertFalse(
            $this->getContainer()->has(
                'SBUERK\\ThemeExtensionDevelopment\\Core13\\Example\\Example',
            ),
            'The other core version\'s implementation must not be registered on TYPO3 v12.',
        );
    }
}
