 ...
 * On v12 the whole `tx_theme_list_item` table and the twenty-six `tx_theme_*`
...
final class DatabaseSchemaTest extends AbstractFunctionalTestCase
{
     ...
     * `foreign_table_field`), and the twenty-six columns
    ...
    public static function expectedColumns(): \Generator
    {
        ...
        yield 'tx_theme_list_item.meta is a string' => [
            'table' => 'tx_theme_list_item',
            'column' => 'meta',
            'type' => StringType::class,
        ];
        yield 'tx_theme_list_item.link_variant is a string' => [
            'table' => 'tx_theme_list_item',
            'column' => 'link_variant',
            'type' => StringType::class,
        ];
        ...
        yield 'tx_theme_list_item.tone is a string' => [
            'table' => 'tx_theme_list_item',
            'column' => 'tone',
            'type' => StringType::class,
        ];
        ...
        yield 'tt_content.tx_theme_icon is a text' => [
            'table' => 'tt_content',
        ...
        yield 'tt_content.tx_theme_eyebrow is a string' => [
            'table' => 'tt_content',
            'column' => 'tx_theme_eyebrow',
            'type' => StringType::class,
        ];
        yield 'tt_content.tx_theme_hero_layout is a string' => [
            'table' => 'tt_content',
            'column' => 'tx_theme_hero_layout',
            'type' => StringType::class,
        ];
        yield 'tt_content.tx_theme_quote_style is a string' => [
            'table' => 'tt_content',
        ...
        // A "type=file" field: v13.4.35 derives the same unsigned integer
        // count column from it as from an inline relation ("case 'file'").
        yield 'tt_content.tx_theme_captions is an integer' => [
            'table' => 'tt_content',
            'column' => 'tx_theme_captions',
            'type' => IntegerType::class,
        ];
    }
