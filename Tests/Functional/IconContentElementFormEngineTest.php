...
final class IconContentElementFormEngineTest extends AbstractFunctionalTestCase
{
     ...
     * without "isInlineChildExpanded", read on v14.3), which says nothing
     * about the form an editor fills in; the state lists every uid of the
     * fixtures, as an editor who opened them all would store it.
     *
     * @return array<string, mixed>
     */
