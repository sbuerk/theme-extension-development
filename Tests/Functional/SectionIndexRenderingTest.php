...
final class SectionIndexRenderingTest extends AbstractFunctionalTestCase
{
     ...
     * menu's page from `$localRootLine[$this->entryLevel]` with `entryLevel`
     * defaulting to 0 - the site root - so without `entryLevel = -1` every
     * page of the site lists the root's elements.
     */
    #[DataProvider('deliveryPaths')]
    #[Test]
