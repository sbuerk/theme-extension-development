 ...
 * value. A class written there and matched by no rule is an editor choice
...
final class ContentElementContractTest extends UnitTestCase
{
    ...
    public function theTemplatesWriteTheModifiersOfEveryAppearanceField(): void
    {
        ...
        // Five frames, ten spacings, three positions, five looks and the text
        // role - fewer means a value lost its case, and the test below would
        // pass on an empty list.
        $this->assertCount(24, $classes, implode(', ', $classes));
    }
