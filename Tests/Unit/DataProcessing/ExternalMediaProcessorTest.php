...
final class ExternalMediaProcessorTest extends UnitTestCase
{
     ...
     * `stdWrapValue()`, and touches neither of the two things that
     * constructor sets up on 12.4.45 and 13.4.35 alike - the frontend
     * controller and the container, both optional there.
     */
