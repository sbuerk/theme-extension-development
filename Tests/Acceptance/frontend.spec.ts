 ...
 * other three arrangements are one setting away (a site setting on TYPO3
 * v13, the constant of the same name on v12) and nothing opened a panel in
 * them - and `centred` put both panels inside the header, over its
