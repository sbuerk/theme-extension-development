...
| [Site settings](site-settings.md)                     | Why every setting is declared twice, what a value nobody planned for may do, and the two label mechanisms the core floor rules out.                     |
