...
| [Site settings](site-settings.md)                     | Why every setting is declared twice — a v13 site setting and a constant, the only path on v12 — what a value nobody planned for may do, and the enum labels the v13.4 ceiling rules out. |
