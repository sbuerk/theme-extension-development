...
A run takes about 60 seconds of specs for 261 tests. It is **not** a
...
|------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|-------|
| axe, WCAG 2.2 AA       | every section × light, dark × every palette                                                                                                         | 180   |
| Screenshot, clipped    | every section × light, dark in `neutral`; the accent swatches and the focus ring of `tokens` and the whole of `buttons` × light, dark × four others | 60    |
...
`tokens` as `tokens-accents-…` and `tokens-focus-…` — 22.7 MB for the 60 today.
