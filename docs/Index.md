...
| [TypoScript delivery](architecture/typoscript-delivery.md)         | Site set on v13, the classic static include on both, the guard condition, the `fluid_styled_content` bridge.                         |
| [Site settings](architecture/site-settings.md)                     | Settings and constants declared side by side, why, the constant as the only path on v12, and what a value nobody planned for may do. |
...
| [Visual tests](testing/visual-tests.md)                   | Screenshots and axe of the styleguide, baselines, rebaselining.        |
