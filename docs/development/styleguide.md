...
| `Navigation.html`  | `navigation`   | `.theme-nav-main`, `.theme-nav-sub`, `.theme-breadcrumb`, `.theme-pagination`, `.theme-language-menu` with its unavailable entry, `.theme-dropdown`, whose panel the browser opens as a popover, `.theme-content-menu`.                                                                                                                                                                                                                                                           |
