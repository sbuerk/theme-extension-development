...
| `Interactive.html` | `interactive`  | The components that need the theme's script — `.theme-tabs`, `.theme-dialog`, `.theme-carousel`, `.theme-lightbox`, `.theme-tooltip` — and what each does without it.                                                                                                                                                                                                                                                                                                             |
