...
| `Navigation.html`  | `navigation`   | `.theme-nav-main`, `.theme-nav-sub`, `.theme-breadcrumb`, `.theme-pagination`, `.theme-language-menu` with its unavailable entry, `.theme-dropdown`, whose panel the browser opens as a popover, `.theme-content-menu`, `.theme-social-links` with and without a logo.                                                                                                                                                                                                            |
...
| `Chrome.html`      | `chrome`       | The site header in the four arrangements the site setting `theme.header.variant` selects, one specimen each: the default single row, centred, with a call to action, and the two-tier meta row.                                                                                                                                                                                                                                                                                   |
