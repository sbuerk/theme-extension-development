...
| `Collections.html` | `collections`  | `.theme-card-grid` with a column count and as a `.theme-card-scroller`, cards with a subtitle and a button, cards whose title is the link, `.theme-split-tiles` in every tone, `.theme-timeline` with and without an icon, `.theme-list-group` with and without a link.                                                                                                                                                                                                           |
