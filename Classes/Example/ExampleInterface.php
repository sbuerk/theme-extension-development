 ...
 * the `Core<major>/` directory of that version — `Core12/` and `Core13/` —
 * which register themselves as the default implementation of this interface
 * with the Symfony dependency injection attribute `#[AsAlias]`.
 *
