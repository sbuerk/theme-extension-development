...
final class IconCatalogue
{
    ...
    public function __construct(
        ...
        private readonly string $categoriesFile = self::CATEGORIES,
    ) {}
     ...
     * a group without items out of the list ("TcaSelectItems" of EXT:backend
     * on v12.4, its "SelectItemProcessor" on v13.4), so building the TCA reads
     * no icon file.
     *
